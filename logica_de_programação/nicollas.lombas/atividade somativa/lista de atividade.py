...
pergunta = int(input("quantos Gigabytes você tem "))

calculo = int(pergunta*1024)
...
pergunta1 = int(input('qual foi sua nota da prova de matematica'))
pergunta2 = int(input('qual foi sua nota da prova de poetuguês'))

calculo = int(pergunta1+pergunta2)
soma = int(calculo/2)
